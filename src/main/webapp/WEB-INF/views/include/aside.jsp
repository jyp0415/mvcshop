...
.bigmenu{font-size: 20px;}
 	...
 	<a  onclick="sprfun('spr1')" href="javascript:void(0)" class="bigmenu button1 button2">
     	대목록
    </a>
	...
	<a onclick="sprfun('spr2')"  href="javascript:void(0)" class="bigmenu button1 button2">
     대목록2
    </a>
